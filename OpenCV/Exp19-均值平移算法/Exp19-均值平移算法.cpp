...
void main()
{
	...
	setMouseCallback("图1", onMouse, reinterpret_cast<void*>(&image));

	Rect rect(297,153,198,251);
	Mat imgROI = image(rect);
	...
	int minSat = 65;
	ColorHistogram hc;
	Mat colorhist = hc.getHueHistogram(imgROI, minSat);
